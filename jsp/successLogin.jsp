...
<title>Data Transfer Page</title>
...
<center><h2>Hello   <%= user.getFirstName() %>   <%= user.getLastName() %>      thank you for logging in.</h2></center>
<br><br><br>
<div>
<center><input type="button" class="w3-btn w3-black" value="Click here to go to Compose Page" onclick="location.href='<%=request.getContextPath()%>/JSP/Compose.jsp?username=<%= user.getUserName() %>'"><br><br><br></center>
<center><input type="button" class="w3-btn w3-black" value="Click here to go to Sent Files Page" onclick="location.href='<%=request.getContextPath()%>/JSP/sent.jsp?username=<%= user.getUserName() %>';"><br><br><br></center>
<center><input type="button" class="w3-btn w3-black" value="Click here to go to Inbox Page" onclick="location.href='<%=request.getContextPath()%>/JSP/Inbox.jsp?username=<%= user.getUserName() %>';"><br></center>
</div>
</body>
</html>