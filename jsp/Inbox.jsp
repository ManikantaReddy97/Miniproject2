...
<center><h2>Hello   <%= user.getFirstName() %>   <%= user.getLastName() %>     see all the Messages that you got Here. </h2><br>
<table border="1px" solid black>
<tr>
<th>Sender Name   </th><th>Receiver Name    </th><th>Written Text   </th><th>Sent Time    </th><th>File Name  </th>
</tr>
<%  final List<Notification> notifications = NotificationData.fetchSentFileData(user.getUserId()); 
